...
from lib.core.android import aapt_permissions
...
from lib.core.common import save_pms_as_arff
...
runtime_state = "E:\\experiment\\experiment1\\apkscan\\output\\runtime_state.txt"
def start():
	"""
	controller start
	"""
	...
	for target in kb.targets:
		...
		send_heartbeat()
		try:
			with open(runtime_state,'a+') as f:	
				f.write("Now, begin to analyse the "+ str(num) + " app!\n")
			...
			#save_pms_as_arff(None,target)
			save_pms_as_arff("E:\\experiment\\experiment1\\apkscan\\output")
